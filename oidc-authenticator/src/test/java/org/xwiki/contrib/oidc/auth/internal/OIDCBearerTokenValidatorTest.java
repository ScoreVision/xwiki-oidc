...
/**
 * Validate {@link OIDCBearerTokenValidator}.
 *
 * @version $Id$
 * @since 2.20.4
 */
@ComponentTest
class OIDCBearerTokenValidatorTest
{
    @InjectMockComponents
    private OIDCBearerTokenValidator validator;
    ...
    {
        when(this.configuration.isBearerTokenEnabled()).thenReturn(false);
    ...
    {
        when(this.configuration.isBearerTokenEnabled()).thenReturn(true);
    ...
    void authenticateReturnsNullWhenNoProviderAndNoIssuer() throws Exception
    {
        ...
        when(this.configuration.getBearerIssuer()).thenReturn(null);
    ...
    void authenticateReturnsNullWhenNoProviderAndEmptyIssuer() throws Exception
    {
        when(this.configuration.isBearerTokenEnabled()).thenReturn(true);
        when(this.configuration.getClientProvider()).thenReturn(null);
        when(this.configuration.getBearerIssuer()).thenReturn("");
